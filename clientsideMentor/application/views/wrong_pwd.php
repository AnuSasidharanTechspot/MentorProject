...
<body>
	<div class="container-fluid">
		...
		<?php
			...
			{
				?>
			<div class="col-md-offset-3 col-md-6 col-md-offset-3 login-box-image">
				<br/>
				...
				<div class="row col-md-offset-2 col-md-9 col-md-offset-1">
					...
					<form role="form" method="post" action="loginControl">
						...
						<div class="col-md-3">
							<img class="img-responsive" src="<?php echo $user['vchr_prof_pic']; ?>">
							<a href="#">Not <?php echo $user['vchr_first_name']." ".$user['vchr_last_name'];?> ?</a>
						</div>
						<div class="col-md-4">
							<h6><?php echo $user['vchr_first_name']." ".$user['vchr_last_name'];?></h6>
							<p class="grey"><?php echo $user['vchr_email']?></p>
							<br/>
							<input type="hidden" name="email" value="<?php echo $user['vchr_email'];?>"><br/>
						</div>
						<div class="col-md-5">
							Password :
						</div>
						<div class="col-md-7 form-group">
							<input class="form-control" name="password" data-toggle="popover" data-content="Password is wrong" type="password"></input>
						</div>
